...
## LOAD DATA
########################################
unit <- readOGR("../fs_admin/data/midewin")
...
ggsave(filename = "figures/midewin_buffer_map.jpg", 
       height = 3, 
       width = 4.2, 
       units = "in")
#---------------------------------------------------------------------------
...
# 
# 
# jpeg("figures/unit_nox_change_11_14.jpg", height = 3, width = 4.2, units  = "in", res = 300)
# 
# add_min_legend(nox_plot)
# 
# dev.off()

ggsave(filename = "figures/midewin_nox_change.jpg",
       plot = nox_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/midewin_so2_change.jpg",
       plot = so2_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/midewin_pm_2_5_change.jpg",
       plot = pm2_5_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/midewin_nei_change_long.jpg",
       height = 8,
       width = 3.7,
       units = "in")
...
write_csv(nei_poll_county_sector,
          "data/midewin_nei_pollutant_sector.csv")
