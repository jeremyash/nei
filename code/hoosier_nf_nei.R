...
## LOAD DATA
########################################
unit <- readOGR("../fs_admin/data/hoosier_nf")
...
ggsave(filename = "figures/hoosier_nf_buffer_map.jpg", 
       height = 3, 
       width = 4.2, 
       units = "in")
#---------------------------------------------------------------------------
...
ggsave(filename = "figures/hoosier_nf_nox_change.jpg",
       plot = nox_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/hoosier_nf_so2_change.jpg",
       plot = so2_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/hoosier_nf_pm_2_5_change.jpg",
       plot = pm2_5_plot,
       height = 3,
       width = 4.2,
       units = "in")
...
ggsave(filename = "figures/hoosier_nf_nei_change_long.jpg",
       height = 8,
       width = 3.7,
       units = "in")
...
write_csv(nei_poll_county_sector,
          "data/hoosier_nei_pollutant_sector.csv")
